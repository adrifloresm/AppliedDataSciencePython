...
get_ipython().run_cell_magic('timeit', '-n 10', 'summary = 0\nfor item in s:\n    summary+=item')


# In[ ]:

get_ipython().run_cell_magic('timeit', '-n 10', 'summary = np.sum(s)')
...
get_ipython().run_cell_magic('timeit', '-n 1', 's = pd.Series(np.random.randint(0,1000,10000))\nfor label, value in s.iteritems():\n    s.loc[label]= value+2')
